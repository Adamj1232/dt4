    ...
    return (
      ...
      <div>
        ...
        <section className="parallax-scrolling" id="bio">
          ...
          Dealer Takes Four is a whiskey-driven rock band hailing from Denver, Colorado. This six-piece powerhouse is known for their raucous live shows, blending elements of classic rock, country, and pop to create a sound that is uniquely their own.

The band formed in 2022, quickly making a name for themselves in the Denver and Colorado Mountain music scene with their high-energy performances and catchy original songs. 
Their debut EP "Shots in the Dark" was released in 2018, showcasing their raw and unfiltered sound that has become their trademark.

The band's live shows are not to be missed, as they are known for their whiskey-fueled performances that leave audiences wanting more. 
With catchy hooks and anthemic choruses, Dealer Takes Four is a band that will have you singing and dancing along all night long.

{/* With the release of their first full-length album "Whiskey & Gold" in 2020,  */}
Dealer Takes Four is poised to take their whiskey-driven rock music to new heights. 
The band is currently touring the country and making waves in the music scene, leaving audiences in awe with their high-energy performances and killer tunes.

Dealer Takes Four is a band that is not to be missed. 
They are a force to be reckoned with, and their whiskey-driven rock music is guaranteed to get your blood pumping. 
Keep an eye out for this Denver-based band, as they are sure to be making waves in the music scene for years to come.
          </p>
        </section>
        ...
        <section className="parallax-scrolling" id="music">
          ...
          <iframe width="100%" height="350" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1548224161&color=%23ae2727&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
          </div>
        ...
        <section className="parallax-scrolling" id="contact">
          ...
          <p className="contact-text">
            ...
            <a
              ...
              href="mailto:DealerTakesFour@gmail.com"
            >
              {" "}
