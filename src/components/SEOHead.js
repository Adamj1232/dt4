...
export default function SEOHead() {
  ...
  return (
    <Helmet>
      ...
      <meta
        name="description"
        content="Experience the greatest American rock n' roll story with Dealer Takes Four (DT4). A unique blend of rock, country, and Americana featuring blazing fiddle, trumpet, and guitar harmonies. Book us for your next event!"
      />
      ...
      <meta
        name="keywords"
        content="Dealer Takes Four, Dealer takes 4, DT4, DTF band, Denver Rock Band, Live Music Colorado, Rock and Roll, Country Rock, Americana Music, Live Entertainment Denver, James and the Devil, Colorado Music"
      />

      {/* Open Graph tags */}
      <meta
        property="og:title"
        content="Dealer Takes Four (DT4) - High-Energy Rock Band from Denver"
      />
      <meta
        property="og:description"
        content="Experience the unique sound of Dealer Takes Four (DT4 / Dealer takes 4) - a powerful blend of rock, country, and Americana music from Denver, Colorado. Book us for your next event!"
      />
      <meta
        property="og:image"
        content={`${baseUrl}/images/WinterDTF-Clean_no_bg_compressed.webp`}
      />
      ...
      <meta
        ...
        content="Experience the unique sound of Dealer Takes Four (DT4 / Dealer takes 4) - a powerful blend of rock, country, and Americana music from Denver, Colorado."
      />
      <meta
        name="twitter:image"
        content={`${baseUrl}/images/WinterDTF-Clean_no_bg_compressed.webp`}
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          description:
            "Experience the greatest American rock n' roll story with Dealer Takes Four (DT4). A unique blend of rock, country, and Americana featuring blazing fiddle, trumpet, and guitar harmonies.",
